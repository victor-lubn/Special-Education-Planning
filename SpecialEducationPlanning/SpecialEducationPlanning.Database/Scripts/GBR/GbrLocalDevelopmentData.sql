...
-- GET IDs for Aieps
DECLARE @Aiep1Id INT = (SELECT Id FROM [dbo].[Aiep] WHERE [AiepCode] = 'DD86') -- North Watford
DECLARE @Aiep2Id INT = (SELECT Id FROM [dbo].[Aiep] WHERE [AiepCode] = 'DF31') -- Epsom (Rlo)
DECLARE @Aiep1Code NVARCHAR(11) = (SELECT AiepCode FROM [dbo].[Aiep] WHERE [AiepCode] = 'DD86')
DECLARE @Aiep2Code NVARCHAR(11) = (SELECT AiepCode FROM [dbo].[Aiep] WHERE [AiepCode] = 'DF31')


-- ======= CREATE USERS
-- CREATE USER WITH FULL ACL ACCESS
INSERT [dbo].[User] ([FirstName], [Surname], [CreatedDate], [CreationUser], [UpdatedDate], [UpdateUser], [UniqueIdentifier], [Discriminator], [AiepId], [ReleaseInfoId], [FullAclAccess], [Leaver], [DelegateToUserId]) VALUES ('DZ99TDP', 'Support', CAST(N'2019-03-26T08:59:15.5633333' AS DateTime2), N'testUserCreate', CAST(N'2019-03-26T08:59:15.5633333' AS DateTime2), N'testUserUpdate', N'DZ99TDP.Support@hwdn.co.uk', N'Support', @Aiep1Id, NULL, 1, 0, NULL)
DECLARE @SupportId INT = (SELECT [Id] FROM [dbo].[User] where [UniqueIdentifier] = 'DZ99TDP.Support@hwdn.co.uk')

-- CREATE USER WITH ACCESS TO EPSOM Aiep (DF31)
INSERT [dbo].[User] ([FirstName], [Surname], [CreatedDate], [CreationUser], [UpdatedDate], [UpdateUser], [UniqueIdentifier], [Discriminator], [AiepId], [ReleaseInfoId], [FullAclAccess], [Leaver], [DelegateToUserId]) VALUES ('DZ99TDP', 'Educationer', CAST(N'2019-03-26T08:59:15.5633333' AS DateTime2), N'testUserCreate', CAST(N'2019-03-26T08:59:15.5633333' AS DateTime2), N'testUserUpdate', N'DZ99TDP.Educationer@hwdn.co.uk', N'Educationer', @Aiep2Id, NULL, 0, 0, NULL)
DECLARE @EducationerId INT = (SELECT [Id] FROM [dbo].[User] where [UniqueIdentifier] = 'DZ99TDP.Educationer@hwdn.co.uk')
...
INSERT [dbo].[EndUser] ([Id], [Address0], [Address1], [Address2], [Address3], [Address4], [Address5], [Comment], [ContactEmail], [CountryCode], [FirstName], [LandLineNumber], [MobileNumber], [Postcode], [Surname], [TitleId], [UniqueIdentifier], [CreatedDate], [CreationUser], [UpdatedDate], [UpdateUser], [FullName]) VALUES (1, N'28 Ravenshurst Avenue  LONDON', N'28 Ravenshurst Avenue', N' LONDON', NULL, NULL, NULL, NULL, N'richard.jones@aiep.com', NULL, N'Richard', NULL, NULL, N'NW44EG', N'Jones', 21, NULL, CAST(N'2021-08-12T12:57:23.2191548' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk', CAST(N'2021-08-12T12:57:23.2191548' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk', N'Richard Jones')
...
INSERT [dbo].[Project] ([Id], [CodeProject], [AiepId], [KeyName], [SinglePlanProject], [CreatedDate], [CreationUser], [UpdatedDate], [UpdateUser]) VALUES (1, FORMATMESSAGE(N'Project for plan %s', @PlanCode1), @Aiep1Id, NULL, 1, CAST(N'2021-08-12T12:57:21.9962581' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk', CAST(N'2021-08-12T12:57:21.9962581' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk')
INSERT [dbo].[Project] ([Id], [CodeProject], [AiepId], [KeyName], [SinglePlanProject], [CreatedDate], [CreationUser], [UpdatedDate], [UpdateUser]) VALUES (2, FORMATMESSAGE(N'Project for plan %s', @PlanCode2), @Aiep2Id, NULL, 1, CAST(N'2021-08-12T12:57:21.9962581' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk', CAST(N'2021-08-12T12:57:21.9962581' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk')
...
INSERT [dbo].[Version] ([Id], [KeyName], [PlanId], [Preview], [Rom], [PreviewPath], [RomPath], [VersionNumber], [VersionNotes], [Range], [CatalogId], [ExternalCode], [AiepCode], [CreatedDate], [CreationUser], [UpdatedDate], [UpdateUser], [QuoteOrderNumber]) VALUES (1, NULL, 1, N'E:\WP765 - Trade Education Platform PSV\Scripts\Ready\07_DV_Modify Plan(Overwrite) (Fusion)_APIs_V1.2\preview_17081017278.jpeg', N'E:\WP765 - Trade Education Platform PSV\Scripts\Ready\07_DV_Modify Plan(Overwrite) (Fusion)_APIs_V1.2\17081017278_SAVE.Rom', N'Version/2019/05/6ec1d8de7a5a44a8b29f0b662d9d3ad4', N'Version/2019/05/4e4da106566344c8ad4d7776ab3740cc', 1, N'Version 1', N'  Allendale Antique White', @KitchenCatalogId, N'F3100000001', @Aiep1Code, CAST(N'2021-08-20T12:33:31.1323218' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk', CAST(N'2021-08-20T12:33:31.1323218' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk', N'')
INSERT [dbo].[Version] ([Id], [KeyName], [PlanId], [Preview], [Rom], [PreviewPath], [RomPath], [VersionNumber], [VersionNotes], [Range], [CatalogId], [ExternalCode], [AiepCode], [CreatedDate], [CreationUser], [UpdatedDate], [UpdateUser], [QuoteOrderNumber]) VALUES (2, NULL, 2, N'E:\WP765 - Trade Education Platform PSV\Scripts\Ready\07_DV_Modify Plan(Overwrite) (Fusion)_APIs_V1.2\preview_17081017278.jpeg', N'E:\WP765 - Trade Education Platform PSV\Scripts\Ready\07_DV_Modify Plan(Overwrite) (Fusion)_APIs_V1.2\17081017278_SAVE.Rom', N'Version/2019/05/6ec1d8de7a5a44a8b29f0b662d9d3ad4', N'Version/2019/05/4e4da106566344c8ad4d7776ab3740cc', 1, N'Version 1', N'  Willow', @LinearCatalogId, N'F4300000009', @Aiep2Code, CAST(N'2021-08-20T12:33:31.1323218' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk', CAST(N'2021-08-20T12:33:31.1323218' AS DateTime2), N'DZ99TDP.Support@hwdn.co.uk', N'')
