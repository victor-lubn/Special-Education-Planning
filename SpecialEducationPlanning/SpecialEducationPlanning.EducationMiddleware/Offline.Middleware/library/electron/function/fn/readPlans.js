        ...
        fs.readFile(file, 'utf8', function (err, data) {
            if (err) {
                ...
                try {
                    ...
                    functions.log.info(`-----------------------------------------------------------------`);
                    send(frontConstants.READING_FILE_SUCCESS, { obj: tryParse });
                    return;
                } catch (e) {
                    functions.log.info('File read failed.  Error: ' + e);
                    functions.log.info(`-----------------------------------------------------------------`);
                    send(frontConstants.ERROR_READING_FILE, e);
                    return;
                }
            }
