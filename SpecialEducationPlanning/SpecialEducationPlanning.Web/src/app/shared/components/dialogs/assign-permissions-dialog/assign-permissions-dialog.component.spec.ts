...
describe('AssignPermissionsDialogComponent,', () => {
    let component: AssignPermissionsDialogComponent;
    let fixture: ComponentFixture<AssignPermissionsDialogComponent>;
    ...
    beforeEach(async(() => {
        ...
        fixture = TestBed.createComponent(AssignPermissionsDialogComponent);
