...
import { CreateEditAreaDialogComponent } from './create-edit-area-dialog.component';


describe('CreateEditAreaDialogComponent,', () => {
    let component: CreateEditAreaDialogComponent;
    let fixture: ComponentFixture<CreateEditAreaDialogComponent>;
    ...
    beforeEach(async(() => {
        ...
        fixture = TestBed.createComponent(CreateEditAreaDialogComponent);
