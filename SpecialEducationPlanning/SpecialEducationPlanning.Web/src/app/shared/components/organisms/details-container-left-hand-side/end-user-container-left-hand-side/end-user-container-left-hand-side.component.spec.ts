...
import { EndUserContainerLeftHandSideComponent } from './end-user-container-left-hand-side.component';
...
describe('EndUserContainerLeftHandSideComponent', () => {
    let component: EndUserContainerLeftHandSideComponent;
    let fixture: ComponentFixture<EndUserContainerLeftHandSideComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(EndUserContainerLeftHandSideComponent);
    ...
    it('should have default values', () => {
        ...
        expect(component.commentsString).toBe('endUser.comments');
        expect(component.commentsPlaceholderString).toBe('endUser.commentsPlaceholder');
    ...
    it('should have one textarea component in select', () => {
        const inputComponents = fixture.debugElement.nativeElement.querySelectorAll('tdp-text-area')
