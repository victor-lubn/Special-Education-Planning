...
export default {
    component: AssignPlanDialogComponent,
    subcomponents: { ModalComponent, ButtonComponent, TdpDateSuffixPipe, TableComponent },
    decorators: [
        moduleMetadata({
    ...
    title: 'Organism/Assign Plan Dialog'
} as Meta;

const Template: Story<AssignPlanDialogComponent> = (args) => ({
    props: {
        ...args,
        onAssignPlan: action('Assigned plan'),
        onCancel: action('Canceled')
    },
    template: `
    <tdp-assign-plan-dialog>
    </tdp-assign-plan-dialog>
    `
});

export const AssignPlan = Template.bind({});
AssignPlan.args = {
    ...AssignTable.args
}
